 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nt{constructor(t){this.app=t}_delete(){return delete I[this.app.options.appId],Promise.resolve()}}let I={},L=[];const B={};let _="dataLayer",xt="gtag",V,me,U=!1;function jt(){const e=[];if(Te()&&e.push("This is a browser extension environment."),Se()||e.push("Cookies are not available."),e.length>0){const t=e.map((a,i)=>`(${i+1}) ${a}`).join(" "),n=d.create("invalid-analytics-context",{errorInfo:t});u.warn(n.message)}}function qt(e,t,n){jt();const a=e.options.appId;if(!a)throw d.create("no-app-id");if(!e.options.apiKey)if(e.options.measurementId)u.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${e.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw d.create("no-api-key");if(I[a]!=null)throw d.create("already-exists",{id:a});if(!U){It(_);const{wrappedGtag:s,gtagCore:r}=vt(I,L,B,_,xt);me=s,V=r,U=!0}return I[a]=$t(e,L,B,t,V,_,n),new Nt(e)}function zt(e=Ie()){e=W(e);const t=k(e,S);return t.isInitialized()?t.getImmediate():Lt(e)}function Lt(e,t={}){const n=k(e,S);if(n.isInitialized()){const i=n.getImmediate();if(ye(t,n.getOptions()))return i;throw d.create("already-initialized")}return n.initialize({options:t})}function Bt(e,t,n,a){e=W(e),Ft(me,I[e.app.options.appId],t,n,a).catch(i=>u.error(i))}const z="@firebase/analytics",G="0.10.8";function Vt(){T(new v(S,(t,{options:n})=>{const a=t.getProvider("app").getImmediate(),i=t.getProvider("installations-internal").getImmediate();return qt(a,i,n)},"PUBLIC")),T(new v("analytics-internal",e,"PRIVATE")),b(z,G),b(z,G,"esm2017");function e(t){try{const n=t.getProvider(S).getImmediate();return{logEvent:(a,i,s)=>Bt(n,a,i,s)}}catch(n){throw d.create("interop-component-reg-failed",{reason:n})}}}Vt();export{zt as getAnalytics,Lt as initializeAnalytics,Bt as logEvent};
